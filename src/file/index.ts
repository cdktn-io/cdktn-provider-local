...
// https://registry.terraform.io/providers/hashicorp/local/2.6.2/docs/resources/file
...
export class File extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing File that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/local/2.6.2/docs/resources/file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/local/2.6.2/docs/resources/file local_file} Resource
  *
  * @param scope The scope in which to define this construct
