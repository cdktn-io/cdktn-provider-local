...
// https://registry.terraform.io/providers/hashicorp/local/2.6.2/docs/data-sources/file
...
export class DataLocalFile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLocalFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/local/2.6.2/docs/data-sources/file#import import section} in the documentation of this resource for the id to use
