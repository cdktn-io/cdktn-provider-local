...
// https://registry.terraform.io/providers/hashicorp/local/2.9.0/docs/data-sources/file
...
export class DataLocalFile extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLocalFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/local/2.9.0/docs/data-sources/file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/local/2.9.0/docs/data-sources/file local_file} Data Source
  *
  * @param scope The scope in which to define this construct
