...
// https://registry.terraform.io/providers/hashicorp/local/2.8.0/docs/resources/sensitive_file
...
*/
export class SensitiveFile extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SensitiveFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/local/2.8.0/docs/resources/sensitive_file#import import section} in the documentation of this resource for the id to use
