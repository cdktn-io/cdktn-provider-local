...
// https://registry.terraform.io/providers/hashicorp/local/2.6.2/docs
...
export class LocalProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing LocalProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/local/2.6.2/docs#import import section} in the documentation of this resource for the id to use
