...
// https://registry.terraform.io/providers/hashicorp/local/2.6.2/docs/data-sources/sensitive_file
...
export class DataLocalSensitiveFile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLocalSensitiveFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/local/2.6.2/docs/data-sources/sensitive_file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/local/2.6.2/docs/data-sources/sensitive_file local_sensitive_file} Data Source
  *
  * @param scope The scope in which to define this construct
