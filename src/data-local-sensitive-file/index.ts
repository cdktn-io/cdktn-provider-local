...
// https://registry.terraform.io/providers/hashicorp/local/2.7.0/docs/data-sources/sensitive_file
...
*/
export class DataLocalSensitiveFile extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLocalSensitiveFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/local/2.7.0/docs/data-sources/sensitive_file#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "local_sensitive_file", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/local/2.7.0/docs/data-sources/sensitive_file local_sensitive_file} Data Source
  *
  * @param scope The scope in which to define this construct
