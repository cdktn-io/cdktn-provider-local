...
| <code><a href="#@cdktn/provider-local.provider.LocalProvider.generateConfigForImport">generate_config_for_import</a></code> | Generates CDKTN code for importing a LocalProvider resource upon running "cdktn plan <stack-name>". |
...
| <code><a href="#@cdktn/provider-local.provider.LocalProvider.property.cdktfStack">cdktf_stack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
