...
```java
import io.cdktn.providers.local.provider_functions.LocalProviderFunctions;

new LocalProviderFunctions(java.lang.String providerLocalName);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-local.providerFunctions.LocalProviderFunctions.Initializer.parameter.providerLocalName">providerLocalName</a></code> | <code>java.lang.String</code> | The local name of the provider in required_providers; |
...
```java
public IResolvable direxists(java.lang.String path)
```
